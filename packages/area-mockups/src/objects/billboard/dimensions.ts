...
export const BILLBOARD = {
  ...
  /** Distance from the face center down to the ground plane. */
  standHeight: 2.0,
  /** Monopole column and its foundation collar. */
  pole: { radius: 0.13, collarRadius: 0.17, collarHeight: 0.12 },
  /** Maintenance catwalk along the bottom edge. */
  catwalk: { width: 4.6, depth: 0.3, thickness: 0.04, drop: 0.1 },
  /** Floodlight fixtures along the top edge: arm reach and lamp size. */
  lights: { count: 3, reach: 0.34, rise: 0.22, radius: 0.07 },
